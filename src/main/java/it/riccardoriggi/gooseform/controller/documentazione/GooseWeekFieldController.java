...
public class GooseWeekFieldController {
	...
	public ResponseEntity<Object> getgooseWeekFieldStandardEqual(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardEqual("gooseWeekField","PAPERA"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseWeekFieldStandardNotEqual(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardNotEqual("gooseWeekField","PAPERA"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}

	@GetMapping("/standard/pattern")
	public ResponseEntity<Object> getgooseWeekFieldStandardPattern(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseWeekField("gooseWeekField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardPattern("gooseWeekField"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseWeekFieldStandardMinText(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseWeekField("gooseWeekField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMinText("gooseWeekField","6"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}

	@GetMapping("/standard/max-text")
	public ResponseEntity<Object> getgooseWeekFieldStandardMaxText(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseWeekField("gooseWeekField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMaxText("gooseWeekField","5"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseWeekFieldStandardMin(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMin("gooseWeekField","8"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseWeekFieldStandardMax(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMax("gooseWeekField","10"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
