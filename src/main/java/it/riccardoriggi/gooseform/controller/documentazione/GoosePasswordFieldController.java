...
public class GoosePasswordFieldController {
	...
	public ResponseEntity<Object> getgoosePasswordFieldStandardMin(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("goosePasswordField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMin("goosePasswordField","8"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}

	@GetMapping("/standard/max")
	public ResponseEntity<Object> getgoosePasswordFieldStandardMax(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("goosePasswordField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMax("goosePasswordField","10"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexMin(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexMax(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldSimpleRenderDISABLE_B_IF_A_NOT_EQUAL_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldSimpleRenderHIDE_B_IF_A_MIN_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldSimpleRenderDISABLE_B_IF_A_MIN_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldSimpleRenderHIDE_B_IF_A_MAX_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldSimpleRenderDISABLE_B_IF_A_MAX_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexRenderHIDE_C_IF_A_NOT_EQUAL_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexRenderDISABLE_C_IF_A_NOT_EQUAL_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexRenderHIDE_C_IF_A_MIN_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexRenderDISABLE_C_IF_A_MIN_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexRenderHIDE_C_IF_A_MAX_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
	...
	public ResponseEntity<Object> getgoosePasswordFieldComplexRenderDISABLE_C_IF_A_MAX_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGoosePasswordField("a"));
		componenti.add(DemoUtil.generaGoosePasswordField("b"));
