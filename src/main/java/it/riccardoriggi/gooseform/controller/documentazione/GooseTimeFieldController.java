...
@RestController
@Slf4j
@RequestMapping(path = "/goose-time-field")
public class GooseTimeFieldController {
	...
	public ResponseEntity<Object> getgooseTimeFieldStandardEqual(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardEqual("gooseTimeField","PAPERA"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseTimeFieldStandardNotEqual(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardNotEqual("gooseTimeField","PAPERA"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}

	@GetMapping("/standard/pattern")
	public ResponseEntity<Object> getgooseTimeFieldStandardPattern(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseTimeField("gooseTimeField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardPattern("gooseTimeField"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseTimeFieldStandardMinText(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseTimeField("gooseTimeField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMinText("gooseTimeField","6"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}

	@GetMapping("/standard/max-text")
	public ResponseEntity<Object> getgooseTimeFieldStandardMaxText(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseTimeField("gooseTimeField"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMaxText("gooseTimeField","5"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseTimeFieldStandardMin(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMin("gooseTimeField","8"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseTimeFieldStandardMax(HttpServletRequest request){
		...
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMax("gooseTimeField","10"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
