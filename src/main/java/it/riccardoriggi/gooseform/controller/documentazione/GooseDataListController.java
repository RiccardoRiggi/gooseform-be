...
public class GooseDataListController {
	...
	public ResponseEntity<Object> getgooseDataListStandardMin(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("gooseDataList"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMin("gooseDataList","8"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}

	@GetMapping("/standard/max")
	public ResponseEntity<Object> getgooseDataListStandardMax(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("gooseDataList"));
		form.setComponents(componenti);
		List<GooseControl> listaControlli = form.getControls();
		listaControlli.add(DemoControlliUtil.getStandardMax("gooseDataList","10"));
		return new ResponseEntity<Object>(form,HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getgooseDataListComplexMin(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListComplexMax(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListSimpleRenderHIDE_B_IF_A_MIN_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListSimpleRenderDISABLE_B_IF_A_MIN_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListSimpleRenderHIDE_B_IF_A_MAX_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListSimpleRenderDISABLE_B_IF_A_MAX_X(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListComplexRenderHIDE_C_IF_A_MIN_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListComplexRenderDISABLE_C_IF_A_MIN_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListComplexRenderHIDE_C_IF_A_MAX_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
	...
	public ResponseEntity<Object> getgooseDataListComplexRenderDISABLE_C_IF_A_MAX_B(HttpServletRequest request){
		GooseForm form = DemoUtil.generaGooseForm();
		List<GooseComponent> componenti = form.getComponents();
		componenti.add(DemoUtil.generaGooseDataListStatica("a"));
		componenti.add(DemoUtil.generaGooseDataListStatica("b"));
