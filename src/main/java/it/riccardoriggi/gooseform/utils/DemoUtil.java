...
//		form.setOriginUrl(generaUrlOrigine());
	...
	public static GooseComponent generaGooseSelectStatica(String id, List<GooseKeyValue> valori, String colorePreferito) {
		GooseComponent componente = new GooseComponent();
		componente.setId(id);
		componente.setLabel(colorePreferito);
		componente.setPopup(generaGoosePopup());
		componente.setFormId("idForm");
		GooseSelect select = new GooseSelect();
		select.setSize(1L);
	...
	public static GooseComponent generaGooseSelectDinamica(String id) {
		...
		http.setUrl("http://localhost:8080/gooseform/documentazione/opzioni");
	...
	public static GooseComponent generaGooseSelectDinamicaDue(String id) {
		...
		GooseHttpRequest http = new GooseHttpRequest();
		http.setUrl("http://localhost:8080/gooseform/documentazione/opzioniDue");
		List<GooseKeyValue> listaHeader = new ArrayList<>();
	...
	public static GooseComponent generaGooseLinkedSelectFiglia(String idFiglio, String idPadre) {
		...
		GooseHttpRequest http = new GooseHttpRequest();
		http.setUrl("http://localhost:8080/gooseform/documentazione/linked");
		List<GooseKeyValue> listaHeader = new ArrayList<>();
		listaHeader.add(new GooseKeyValue("HEADER_1", "VALORE CUSTOM HEADER"));
		http.setHeaders(listaHeader);
		http.setMethod("POST");
	...
	public static GooseComponent generaGooseTextField(String id, String nome) {
		GooseComponent componente = new GooseComponent();
		componente.setId(id);
	...
	public static GooseComponent generaGooseDateField(String id, String nome) {
		GooseComponent componente = new GooseComponent();
		componente.setId(id);
		componente.setLabel(nome);
		componente.setPopup(generaGoosePopup());
