...
INSERT INTO `t_render` (`type`, `k`, `description`) VALUES ('SIMPLE_RENDER', 'DISABLE_B_IF_A_MIN_X', 'Disabilita B se A è minore di un determinato valore');
INSERT INTO `t_render` (`type`, `k`, `description`) VALUES ('SIMPLE_RENDER', 'HIDE_B_IF_A_MAX_X', 'Nascondi B se A è maggiore di un determinato valore');
...
INSERT INTO `t_render` (`type`, `k`, `description`) VALUES ('COMPLEX_RENDER', 'DISABLE_C_IF_A_MIN_B', 'Disabilita B se A è minore di B');
INSERT INTO `t_render` (`type`, `k`, `description`) VALUES ('COMPLEX_RENDER', 'HIDE_C_IF_A_MAX_B', 'Nascondi B se A è maggiore di B');
INSERT INTO `t_render` (`type`, `k`, `description`) VALUES ('COMPLEX_RENDER', 'DISABLE_C_IF_A_MAX_B', 'Disabilita B se A è maggiore di B');